    ...
    return (
        <div className={style.block}>
           ...
           <div className={style.container}>
               ...
               <Link  key={date[0].id} to={`/event${date[0].id}`} > <div className={style.cards}>
               ...
               </Link>
                {
                   ...
                   if( i > 0 && i<6 && i !==3 )  {
                       return<Link key={e.id} to={`/event${e.id}`}> <div className={style.card}>
                       ...
                       return<Link key={e.id} to={`/event${e.id}`}> <div className={style.orange}>
